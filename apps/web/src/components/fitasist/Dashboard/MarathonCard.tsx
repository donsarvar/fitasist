...
export const MarathonCard = memo(function MarathonCard({ onOpenMarathons }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Main Content Layout (Clean & Balanced Perspective) */}
      <div className="relative z-10">
        ...
        {/* Bottom Info Grid: Left Countdown & Details, Right Action Pill */}
        <div className="mt-5 flex items-end justify-between gap-3 pt-2">
          <div>
            ...
            {/* Location & Date */}
            <div className="mt-2 flex items-center gap-2 text-[11px] font-semibold text-slate-600 dark:text-slate-300">
              <span className="flex items-center gap-1">
                <MapPin size={13} weight="fill" className="text-[#5850EC]" />
                {next.city}
              </span>
          ...
          <div className="px-4 py-2 rounded-2xl bg-white/90 dark:bg-white/15 backdrop-blur-md border border-slate-200/80 dark:border-white/20 shadow-xs flex items-center gap-1.5 text-[11px] font-extrabold text-[#4F46E5] dark:text-white group-hover:bg-[#5850EC] group-hover:text-white transition-all">
